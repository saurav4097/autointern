...
export default function UiuxRole() {
...
>
          ...
          {days < 20 && (
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
              ...
              <div className="mt-4 flex gap-6 text-sm">
                ...
                <a href="/uiuxguidesheet.pdf" className="text-blue-600">View PDF Guide</a>
              </div>

              {/* TASK STEPS */}
              <div className="mt-6 space-y-3">
                {["UX Audit & Understanding", "Complete Page Redesign (Figma)", "Design System & Components", "Feature Enhancement & Innovation"].map((t, i) => (
  ...
  <ul className="text-gray-600 leading-7 space-y-2">
    <li>
      <span className="font-semibold text-gray-800">Figma design link:</span>{" "}
      Submit the Figma design link containing your complete work, including all screens, components, and design system.
    </li>
    <li>
      ...
      {submissions["project1"] ? "Submitted" : "Submit Project"}
          ...
          {days >= 15 && days < 30 && (
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
              ...
              <div className="mt-6 space-y-3">
                {["UX Audit of Booking Flow", "Redesign Homepage in Figma", "Improve Micro-interactions"].map((t, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-green-500 text-white flex items-center justify-center text-sm">
                      {i + 1}
                    </div>
